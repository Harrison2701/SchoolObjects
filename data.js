...
allStudents.push(new Student("Clark","Kent",12));
allStudents.push(new Student("Bruce","Wayne",12));

allTeachers.push(new Teacher("Carlos","Mantos","Economics"));
...
allSections.push(new Section("English",30));
allSections.push(new Section("Economics",69));
